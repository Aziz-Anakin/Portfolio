...
export const SKILLS = {
  creation: [
    { name: 'Canva',      logo: canvaLogo,                                                                                          href: 'https://www.canva.com' },
  ...
  dev: [
    ...
    { name: 'shadcn/ui',    logo: 'https://cdn.simpleicons.org/shadcnui', invert: true,                                                                        href: 'https://ui.shadcn.com' },
    ...
    { name: 'Express',      logo: `${DEV}/express/express-original.svg`, invert: true,                                                                        href: 'https://expressjs.com' },
    { name: 'Discord.js',   logo: `${DEV}/discordjs/discordjs-original.svg`,                                                                                  href: 'https://discord.js.org' },
    ...
    { name: 'Bash',         logo: `${DEV}/bash/bash-original.svg`,                                                                                            href: 'https://www.gnu.org/software/bash' },
    { name: 'PostgreSQL',   logo: `${DEV}/postgresql/postgresql-original.svg`,                                                                                href: 'https://www.postgresql.org' },
    { name: 'MySQL',        logo: `${DEV}/mysql/mysql-original.svg`,                                                                                          href: 'https://www.mysql.com' },
    { name: 'SQLite',       logo: `${DEV}/sqlite/sqlite-original.svg`,                                                                                         href: 'https://www.sqlite.org' },
    { name: 'MongoDB',      logo: `${DEV}/mongodb/mongodb-original.svg`,                                                                                       href: 'https://www.mongodb.com' },
  ],
  tools: [
    ...
    { name: 'Claude Code',  logo: "https://cdn.simpleicons.org/claude",                                                                                       href: 'https://claude.com/claude-code' },
    { name: 'Codex',        logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/openai.svg", invert: true,                                          href: 'https://openai.com/codex' },
  ],
}
