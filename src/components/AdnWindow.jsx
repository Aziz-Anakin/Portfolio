      ...
      >
        ...
        <main className="min-h-0 flex-1 overflow-y-auto">
          ...
          <div className="relative">
            <img src={anime.image} alt={anime.name} className="h-40 w-full object-cover sm:h-72" />
            <div className="absolute inset-0 bg-gradient-to-t from-[#080b18] via-[#080b18]/50 to-transparent" />
            <div className="absolute inset-x-4 bottom-3 flex flex-col gap-2 sm:inset-x-5 sm:bottom-4 sm:gap-3">
              <h3 className="font-anton text-2xl uppercase leading-none tracking-wide text-white sm:text-4xl">
                {anime.name}
              </h3>
              <span
                className="inline-flex w-fit items-center gap-1.5 rounded-full px-3.5 py-1.5 font-code text-[11px] font-bold uppercase tracking-wide text-[#04121f] shadow-lg sm:gap-2 sm:px-5 sm:py-2 sm:text-xs"
              ...
              {ADN_ANIMES.map((a, i) => (
                <li key={a.id}>
                  ...
                  >
                    ...
                    <span className="block truncate bg-[#0d1226] px-2 py-1.5 font-code text-[10px] font-semibold text-white sm:px-2.5 sm:py-2 sm:text-[11px]">
                      {a.name}
                    </span>
                  </button>
                </li>
