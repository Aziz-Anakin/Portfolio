    ...
    <footer className="relative z-10 bg-transparent">
      <div className="max-w-content mx-auto px-5 sm:px-8 py-6 text-center">
        <p className="text-xs text-slate-600 dark:text-white">
          <span className="font-code font-semibold text-slate-600 dark:text-white">Mdoughy Yanis</span>
          {' — Étudiant en informatique à Epitech Paris'}
        </p>
        <a
          href={`${import.meta.env.BASE_URL}qr/`}
          className="inline-flex items-center gap-1.5 mt-2 text-xs text-slate-600 hover:text-blue-600 dark:text-white dark:hover:text-blue-400 transition-colors"
        >
